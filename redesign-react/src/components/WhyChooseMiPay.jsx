...
const reasons = [
  {
    quote: 'Launch prepaid card and wallet onboarding quickly with secure user activation flows.',
    author: 'Fast User Activation',
    role: 'Shorten onboarding time from registration to first transaction.',
    company: 'Onboarding',
  },
  {
    quote: 'Serve unbanked and mobile-first users with prepaid access and daily wallet utility.',
    author: 'Financial Inclusion',
    role: 'Expand payment access for workforce and community users.',
    company: 'Wallet Access',
  },
  {
    quote: 'Manage top-ups, spending controls, and transaction visibility in one mobile ecosystem.',
    author: 'Operational Visibility',
    role: 'Keep users, support teams, and finance aligned.',
    company: 'Control',
  },
]

export function WhyChooseMiPay() {
