...
const serviceImages = {
    ...
    'E-Wallet Integration (MiPay)': 'https://images.unsplash.com/photo-1556742049-908f4bb0a3d8?auto=format&fit=crop&q=80&w=800',
    'Micro Lending': 'https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?auto=format&fit=crop&q=80&w=800',
    'XPAT Jobs': 'https://images.unsplash.com/photo-1616077168712-fc6c788cd4ee?auto=format&fit=crop&q=80&w=800',
    ...
    'FoWeX Networking': 'https://images.unsplash.com/photo-1521791136064-7986c2920216?auto=format&fit=crop&q=80&w=800',
    'S4S Sim & Wallet apps': 'https://images.unsplash.com/photo-1534078829399-1d222b20345c?auto=format&fit=crop&q=80&w=800',

    // Enterprise
    'SAP Business One (B1) & OneERP Implementation': 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=800',
    'e-Invoice': 'https://images.unsplash.com/photo-1554224155-1696413565d3?auto=format&fit=crop&q=80&w=800',
    'Cyber Security': 'https://images.unsplash.com/photo-1510511459019-5dda7724fd87?auto=format&fit=crop&q=80&w=800',
...
const serviceCategories = {
    ...
    'E-Wallet Integration (MiPay)': 'Fintech',
    'Micro Lending': 'Finance',
    'XPAT Jobs': 'Fintech',

    'HR & Payroll Solution': 'HR Tech',
    'E-Wages Solution': 'HR Tech',
    'FoWeX Networking': 'Services',
    'S4S Sim & Wallet apps': 'Telco',

    'SAP Business One (B1) & OneERP Implementation': 'Enterprise',
